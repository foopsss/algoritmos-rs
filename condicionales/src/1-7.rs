...
fn main() {
    let a: i16 = read_integer("Ingrese un valor para a");
    let b: i16 = read_integer("Ingrese un valor para b");
    let suma: i16 = a + b;

    println!("");
    match suma {
        // i16:MIN hace refencia al mínimo valor aceptado por un entero con signo de 16 bits.
